...
# pars_MAC1975$thetas[] <- .2
# pars_MAC1975$min_alphas[] <- 0
...
pars_RW1972$betas_on[] <- .05
pars_RW1972$betas_off[] <- .05
...
# set learning rate
pars_PKH1982$betas_ex[] <- .2
pars_PKH1982$betas_in[] <- .2
pars_PKH1982$gammas[] <- .1
